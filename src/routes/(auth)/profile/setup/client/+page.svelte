<script lang="ts">
  ...
  import { MapPin, User, Phone, FileText } from 'lucide-svelte'
  ...
  async function handleSubmit(e: SubmitEvent) {
    ...
    try {
      const res = await fetch('/api/user/update', {
        ...
        body: JSON.stringify({ bio, phone, city }),
      })
          ...
          <Field.Group>
            ...
            <Field.Field>
              ...
              <textarea
                id="bio"
                bind:value={bio}
                placeholder="Розкажіть ким ви є і що шукаєте..."
                rows="4"
