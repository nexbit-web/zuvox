...
<div class={cn('flex flex-col gap-6', className)} {...restProps}>
  <Card.Root>
    <Card.Header class="text-center">
      <Card.Title class="text-xl">Ласкаво просимо</Card.Title>
      <Card.Description
        >Увійдіть за допомогою свого облікового запису Apple або Google</Card.Description
      >
    </Card.Header>
    <Card.Content>
      <form>
        <FieldGroup>
          ...
          <Field>
            ...
            <Input id="password-{id}" type="Пароль" required />
          </Field>
          <Field>
  ...
  <FieldDescription class="px-6 text-center">
    Нажимаючи «Продовжити», ти погоджуєшся з нашими <a href="##"
